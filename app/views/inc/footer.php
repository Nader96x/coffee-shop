...
<footer class="site-footer site-footer__3 pt-115 position-relative bg_img" data-opacity="8" data-overlay="dark" data-background="<?php echo URLROOT; ?>/assets/images/bg/footer-3-1.jpg">
                ...
                <div class="col-xl-3 col-lg-6 mt-30">
                    <div class="footer__widget footer__info">
                        <div class="item d-flex align-items-center justify-content-center">
                            <img src="<?php echo URLROOT; ?>/assets/images/icons/ft-phone.png" alt="">
                            <span>Phone :</span>
                ...
                <div class="col-xl-4 col-lg-6 mt-30 pl-55">
                    <div class="footer__widget footer__info">
                        <div class="item d-flex align-items-center justify-content-start">
                            <img src="<?php echo URLROOT; ?>/assets/images/icons/ft-map-marker.png" alt="">
                            <span>Address :</span>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="footer__logo--content">
                        <img class="mb-15" src="<?php echo URLROOT; ?>/assets/images/logo/logo.png" alt="">
...
<!--========= JS Here =========-->
<script src="<?php echo URLROOT; ?>/assets/js/jquery-2.2.4.min.js"></script>
...
<script src="<?php echo URLROOT; ?>/assets/js/lightcase.js"></script>
<script src="<?php echo URLROOT; ?>/assets/js/owl.carousel.min.js"></script>
<script src="<?php echo URLROOT; ?>/assets/js/tilt.jquery.min.js"></script>
<script src="<?php echo URLROOT; ?>/assets/js/wow.min.js"></script>
<script src="<?php echo URLROOT; ?>/assets/js/jquery.easing.min.js"></script>
<script src="<?php echo URLROOT; ?>/assets/js/scrollwatch.js"></script>
<script src="<?php echo URLROOT; ?>/assets/js/sticky-header.js"></script>
<script src="<?php echo URLROOT; ?>/assets/js/waypoint.js"></script>
<script src="<?php echo URLROOT; ?>/assets/js/imagesloaded.pkgd.min.js"></script>
...
<script src="<?php echo URLROOT; ?>/assets/js/jquery-ui-slider-range.js"></script>
