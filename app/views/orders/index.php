                    ...
                    foreach ($orders
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } ?>
                                <?php if (isUser() && $order->status == 'Processing') { ?>
                                    <form class="d-inline-block"
                                          action="<?php echo URLROOT; ?>/orders/cancel/<?php echo $order->id; ?>"
                                          method="post">
                                        <input type="text" name="id" value="<?= $order->id ?>" hidden>
                                        <?php
                                        if ($order->status == 'Processing') {
                                            echo '<input type="submit" value="Cancel" class="btn btn-outline-danger">';
                                            ?>
                                        <?php } ?>
                                    </form>
                                <?php } ?>
